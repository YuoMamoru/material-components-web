...
| `registerResizeHandler(handler: EventListener) => void` | ルート要素に resize イベントのイベントリスナを追加する。 |
| `deregisterResizeHandler(handler: EventListener) => void` | ルート要素から resize イベントのイベントリスナを削除する。 |
